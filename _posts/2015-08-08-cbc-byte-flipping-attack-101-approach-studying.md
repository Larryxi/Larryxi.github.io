...
categories: studying
layout: default
excerpt: "翻译：修改密文字节来达到修改明文字节的原理及利用"
---
...
**加密过程**
![Encryption]({{site.baseurl}}/assets/images/20150808/Encryption.png)
**Plaintext**：待加密的数据。
...
**Decryption Process**
![Decryption]({{site.baseurl}}/assets/images/20150808/Decryption.png)
...
![attack]({{site.baseurl}}/assets/images/20150808/attack.jpg)
...
运行这段代码后，我们可以将数字6变为7：
![pic1]({{site.baseurl}}/assets/images/20150808/pic1.png)
...
![pic2]({{site.baseurl}}/assets/images/20150808/pic2.png)
...
![pic3]({{site.baseurl}}/assets/images/20150808/pic3.png)
